...
public partial class AdventurerCard : Panel
{
...
public static AdventurerCard CreateCardFor(Guest guest)
{
	var card = GD.Load<PackedScene>("res://Scenes/UI/AdventurerCard.tscn").Instantiate<AdventurerCard>();
